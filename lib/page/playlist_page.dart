  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          if(box.values.isEmpty) {
            ...
            return ReorderableListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                Duration clipDuration = Duration(milliseconds: (currentClip!.duration * 1000).toInt());
                return Padding(
                  key: Key("$index"),
                    ...
                    child: ListTile(
                      ...
                      leading: ReorderableDragStartListener(
                        ...
                        child: IconButton(
                          ...
                          icon: Icon(currentClip.isEnabled ? Icons.radio_button_checked : Icons.radio_button_unchecked),
                        ),
                      ),
                      trailing: Row(
                            ...
                            onPressed: () {
                              showDialog(
                                ...
                                builder: (_) => SimpleDialog(
                                  title: Text("PLAYLIST_AUDIO_ALERT_TITLE".tr()),
                                  children: [
                                    TextButton(
                                      onPressed: () {
                                        box.deleteAt(index);
                                      ...
                                      child: Text("PLAYLIST_AUDIO_ALERT_ACTION_DELETE".tr()),
                                    ),
                                  ],
                                ),
                              );
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ImportPage()));
        },
      ),
    );
  }
