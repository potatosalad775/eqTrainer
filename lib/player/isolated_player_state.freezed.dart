...
class _$IsolatedPlayerStateCopyWithImpl<$Res, $Val extends IsolatedPlayerState>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      pEQState: null == pEQState
          ? _value.pEQState
          : pEQState // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$_IsolatedPlayerState
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'IsolatedPlayerState(format: $format, filePath: $filePath, volume: $volume, duration: $duration, position: $position, state: $state, pEQState: $pEQState)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('pEQState', pEQState));
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.pEQState, pEQState) ||
                other.pEQState == pEQState));
  }

  @override
  int get hashCode => Object.hash(runtimeType, format, filePath, volume,
      duration, position, state, pEQState);
