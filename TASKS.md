...
- [x] **M18 — Test fixtures shipped in release.** `pubspec.yaml:124-125` declares `test/fixtures/audio/` as an app asset → bundled into every release binary, all 5 platforms. → Remove from `flutter: assets:`, load via file I/O in tests.
